...
$pertanyaan = ["bkuu","irot","libom","siruk","iem","lapak luat","rotom gdee","rudit siagn","maya goregn","isan goregn"]

#ini array yang berisi jawaban
$jawaban = ["buku","roti","mobil","kursi","mie","kapal laut","motor gede","tidur siang","ayam goreng","nasi goreng"]
